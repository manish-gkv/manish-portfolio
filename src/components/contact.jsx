...
import { EMAIL_ACCESS_KEY } from "../cosntant";
        ...
        <>
            <div id="contact" className="py-20 p-8 md:px-0 flex flex-col gap-4 max-w-3xl mx-auto">
                ...
                <form className="flex flex-col gap-4" onSubmit={onSubmit}>
                    ...
                    <input type="submit" value="Submit" className={`bg-black text-white py-2 rounded-md font-medium ${messageSending ? "cursor-not-allowed":"cursor-pointer"}`} />
                </form>
            </div>
            {messageSent && (
